...
FastDom.prototype._flush = function() {
  ...
  try {
    runTasks(this.reads);
    runTasks(this.writes);
  } catch (e) { error = e; }

  this.scheduled = false;

  // If the batch errored we may still have tasks queued
  if (this.reads.length || this.writes.length) scheduleFlush(this);
...
/**
 * Expose 'fastdom' to AMD and CJS systems
 */

if (typeof module != 'undefined' && module.exports) module.exports = fastdom;
else if (typeof define == 'function' && define.amd) define(function(){ return fastdom; });
})(window.fastdom);
